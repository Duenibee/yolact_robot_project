...
cig_snack_dataset = dataset_base.copy({
    'name': 'snack',
...
yolact_resnet50_cig_snack_config = yolact_resnet50_config.copy({
    'name': 'yolact_resnet50_snack',  # Will default to yolact_resnet50_pascal

    # Dataset stuff
    'dataset': cig_snack_dataset,
    'num_classes': len(cig_snack_dataset.class_names) + 1,
